...
@register_model
class PVT_V2_B0(torch.nn.Module):
    def __init__(self, pretrained=False):
        super().__init__()
        self.model = pvt_v2_b0(num_classes=2, pretrained=pretrained)
...
@register_model
class PVT_V2_B1(torch.nn.Module):
    def __init__(self, pretrained=False):
        super().__init__()
        self.model = pvt_v2_b1(num_classes=2, pretrained=pretrained)
        self.model.head = None
