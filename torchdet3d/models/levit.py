...
specification = {
    'LeViT_128S': {
        'C': '128_256_384', 'D': 16, 'N': '4_6_8', 'X': '2_3_4', 'drop_path': 0.05,
...
@register_model
def LeViT_128S_(num_classes=1000, distillation=True,
...
@register_model
def LeViT_128_(num_classes=1000, distillation=True,
              pretrained=False, fuse=False):
...
@register_model
class LeViT_128S(torch.nn.Module):
    def __init__(self, pretrained=False):
        super().__init__()
        self.model = LeViT_128S_(num_classes=2, distillation=False,
              pretrained=pretrained, fuse=False)
...
@register_model
class LeViT_128(torch.nn.Module):
    def __init__(self, pretrained=False):
        super().__init__()
        self.model = LeViT_128_(num_classes=2, distillation=False,
              pretrained=False, fuse=False)
        self.model.head = None
